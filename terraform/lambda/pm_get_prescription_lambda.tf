module "get_prescription_lambda" {
  ...
  artifacts_dir = "academy2022/lambda_function_get_prescription_avinash"
  store_on_s3 = true
...
resource "aws_lambda_function" "get_prescription_lambda_function" {
  function_name = "lambda_function_get_prescription_avinash"
  ...
  handler = "get_prescription.lambda_get_prescription_avinash.get_prescription"
  runtime = "python3.9"
